...
"场景": [
   ...
   # "忌口":
    ...
    #"过敏原":
    "allergens" : [ "花生", "坚果", "花仁", "落花生", "peanut", "nuts", "牛奶", "乳制品", "奶制品", "dairy", "牛乳", "鲜奶", "乳酪", "海鲜", "海产", "海产品", "鱼虾", "甲壳类", "贝类", "seafood", "鸡蛋", "蛋", "卵", "蛋制品", "egg", "大豆", "黄豆", "毛豆", "豆制品", "soy", "小麦", "面粉", "麦子", "麦类", "wheat", "杏仁", "核桃", "腰果", "榛子", "松子", "开心果", "芝麻", "胡麻", "芝麻油", "sesame", "虾", "蟹", "小龙虾", "皮皮虾", "虾爬子" ]
}
